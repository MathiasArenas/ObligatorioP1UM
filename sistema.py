...
class Sistema:
    ...
    # Tripulantes
    tripulante1 = Tripulante("Ana", "López", "55667788", "ana.lopez@airline.com", "096333444", "Piloto", "15/01/2010", 5000)
    tripulante2 = Tripulante("Pedro", "Martínez", "99887766", "pedro.martinez@airline.com", "095555666", "Azafata", "20/03/2015", 2500)
    tripulante3 = Tripulante("Juan", "Mendez", "99887744", "juan.mendez@airline.com", "095555123", "Copiloto", "20/03/2015", 150)
    tripulante4 = Tripulante("Laura", "Gómez", "11224433", "laura.gomez@airline.com", "094444555", "Azafata", "10/07/2018", 1200)
    tripulante5 = Tripulante("Esteban", "Ruiz", "22334455", "esteban.ruiz@airline.com", "093333222", "Piloto", "01/05/2008", 6200)
    tripulante6 = Tripulante("Natalia", "Cabrera", "33445566", "natalia.cabrera@airline.com", "092222111", "Copiloto", "30/11/2012", 3100)
    tripulante7 = Tripulante("Gustavo", "Pereyra", "44556677", "gustavo.pereyra@airline.com", "091111000", "Azafata", "18/04/2016", 1800)
    tripulante8 = Tripulante("Mónica", "Sosa", "55667799", "monica.sosa@airline.com", "090000999", "Azafata", "25/09/2019", 950)
    tripulante9 = Tripulante("Ricardo", "Alonso", "66778800", "ricardo.alonso@airline.com", "089999888", "Piloto", "12/02/2005", 7200)
    tripulante10 = Tripulante("Carla", "Ferrer", "77889911", "carla.ferrer@airline.com", "088888777", "Copiloto", "05/06/2013", 2700)

    # Compañías
    compania1 = Compania("Sky Airlines", "Uruguay", "COMP001")
    compania2 = Compania("Blue Wings", "Argentina", "COMP002")
    compania3 = Compania("Andes Jet", "Chile", "COMP003")
    compania4 = Compania("Tango Air", "Argentina", "COMP004")
    compania5 = Compania("Sol del Sur", "Uruguay", "COMP005")
    compania6 = Compania("Amazonas Fly", "Brasil", "COMP006")
    compania7 = Compania("Patagonia Wings", "Chile", "COMP007")
    compania8 = Compania("Altura Jet", "Perú", "COMP008")
    compania9 = Compania("Pampa Air", "Argentina", "COMP009")
    compania10 = Compania("AeroPacífico", "México", "COMP010")
    ...
    # Vuelos
    vuelo1 = Vuelos("Montevideo", "Buenos Aires", 3.25, "15/06/2026 10:30", compania1, 5, "Internacional", "VL001", "Activo", [])
    vuelo2 = Vuelos("Buenos Aires", "São Paulo", 2.5, "16/06/2026 14:20", compania2, 2, "Internacional", "VL002", "Activo", [])
    vuelo3 = Vuelos("Santiago", "Lima", 3.0, "17/06/2026 09:00", compania3, 3, "Internacional", "VL003", "Activo", [])
    vuelo4 = Vuelos("Montevideo", "Asunción", 2.0, "18/06/2026 11:45", compania5, 4, "Internacional", "VL004", "Activo", [])
    vuelo5 = Vuelos("Montevideo", "Punta del Este", 0.75, "23/06/2026 07:30", compania1, 100, "Nacional", "VL005", "Activo", [])

    lista_vuelos.extend([vuelo1, vuelo2, vuelo3, vuelo4, vuelo5])

    # Tickets
    ticket_v1_1 = Ticket("TKT_VL001_001", cliente1, "Activo", vuelo1, numero_asiento=1)
    vuelo1.tickets.append(ticket_v1_1)
    vuelo1.tripulantes.extend([tripulante1, tripulante2, tripulante3])

    ticket_v1_2 = Ticket("TKT_VL001_002", cliente6, "Activo", vuelo1, numero_asiento=2)
    vuelo1.tickets.append(ticket_v1_2)

    ticket_v1_3 = Ticket("TKT_VL001_003", cliente7, "Activo", vuelo1, numero_asiento=3)
    vuelo1.tickets.append(ticket_v1_3)

    ticket_v1_4 = Ticket("TKT_VL001_004", cliente5, "Activo", vuelo1, numero_asiento=4)
    vuelo1.tickets.append(ticket_v1_4)

    ticket_v2_1 = Ticket("TKT_VL002_001", cliente2, "Activo", vuelo2, numero_asiento=1)
    vuelo2.tickets.append(ticket_v2_1)

    ticket_v2_2 = Ticket("TKT_VL002_002", cliente8, "Activo", vuelo2, numero_asiento=2)
    vuelo2.tickets.append(ticket_v2_2)

    ticket_v2_3 = Ticket("TKT_VL002_003", cliente9, "Activo", vuelo2, numero_asiento=3)
    vuelo2.tickets.append(ticket_v2_3)

    ticket_v3 = Ticket("TKT_VL003_001", cliente3, "Activo", vuelo3, numero_asiento=1)
    vuelo3.tickets.append(ticket_v3)

    ticket_v3_2 = Ticket("TKT_VL003_002", cliente10, "Activo", vuelo3, numero_asiento=2)
    vuelo3.tickets.append(ticket_v3_2)

    ticket_v4_1 = Ticket("TKT_VL004_001", cliente4, "Activo", vuelo4, numero_asiento=1)
    ...
    def casos_opciones(opcion):
        match opcion:
            ...
            case 3:
                Utiles.cls()
                vuelo = Vuelos.registrar_vuelo(Sistema.lista_companias, Sistema.lista_vuelos)
                if vuelo is None:
